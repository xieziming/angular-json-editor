...
Install with npm
```sh
npm install --save angular-json-editor
```

Import the editor module
```typescript
import { JSONEditorModule } from 'angular-json-editor';
```
...
import { JsonEditorComponent, JsonEditorOptions } from 'angular-json-editor';
